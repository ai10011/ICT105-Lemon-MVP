...
## Project Overview
Lemon MVP is an automated web-based indexing and discovery portal designed to eliminate the friction and chaos of scattered, unstructured lost-and-found communications on university campuses. Instead of forcing users to rely on random social media group chats or manual physical inquiries at desks, Lemon MVP provides an organized platform where students (Losers and Finders) and campus security/admin staff can report, verify, and resolve personal property tracking seamlessly.

---

## Lab 5 Deliverables & Navigation Guide
We have expanded our repository to include full UI/UX specifications, wireframes, and active HTML mockups for our application. Use the links below to navigate our submission:

### 1. Product Concept & Requirement Mapping
* [Product Concept (`product-concept.md`)](docs/product-concept.md) - Outlines our formal system core, architecture, and technology framework.
* [Feature-Requirement Mapping](docs/feature-requirement-mapping.md) - Maps our initial validated problem assumptions into explicit system features.

### 2. Wireframe Specifications & Usability Checklist
* [Wireframe Specification Manual](docs/wireframe-specification.md) - Technical component breakdown explaining the layout and content requirements for each screen view.
* [Usability Verification Checklist](docs/wireframe-usability-checklist.md) - Completed review demonstrating design compliance with academic UX/UI standards.

### 3. User Flow Diagrams & Visual Mockups
* [User Flow Config File](diagrams/user-flow.mmd) - Native Mermaid file tracking structural user paths for Losers, Finders, and Admin staff.
* [Wireframe Mockup Folders](wireframes/) - Houses our structural blueprints for the system's interface templates.

### 4. Interactive Clickable HTML Prototype
Our 6 mandatory views are built using pure semantic front-end templates populated with realistic sample dataset elements to mock live interactions. 
* [Homepage Interface (index.html)](index.html) - Main landing directory routing users to primary reporting and searching channels.
* [Input Reporting Form (form.html)](form.html) - Validated data capture portal matching entries to our sample storage patterns.
* [Records Index List (record-list.html)](record-list.html) - Filterable table environment for scanning discovered campus items.
* [Item Detail Workspace (detail.html)](detail.html) - Individual property file presentation containing verification metrics.
* [Analytical Metrics Dashboard (dashboard.html)](dashboard.html) - Visual summaries tracking campus trends and resolution cycles.
* [Administrative Console (admin.html)](admin.html) - Backend control manager allowing office clerks to safely change claiming status logs.

---

##  Project Status & Continuity
* [Weekly Logbook](docs/weekly-logbook.md) - Tracks our sprint reflections, team task alignments, and design pivot decisions made during Lab 5.
