...
|---|---|---|---|---|---|---|
| A-01 | User problem | Students need a faster and easier way to report lost items than using chat groups or asking friends. | FR-01 / US-01 Report Lost Item | High | Case study, preliminary interviews | Observe users completing a lost-item report using the prototype. |
| A-02 | Value proposition | Students will prefer using the digital lost-and-found system over informal methods because it is faster and more organized. | FR-02 / US-02 Search Found Items | High | Case study assumption | Compare users' preference after trying the prototype versus current methods. |
| A-03 | Usability | Users can easily understand the report, search, and claim workflow without additional instructions. | FR-03 / US-03 View Item Details | Medium | No evidence yet | Conduct task-based usability testing and measure task completion rate. |
